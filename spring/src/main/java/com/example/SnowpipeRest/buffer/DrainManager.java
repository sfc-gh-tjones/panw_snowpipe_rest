...
public class DrainManager implements Runnable {
  ...
  private final int maxDurationToDrainMs;
  private final int maxRecordsToDrain;
  ...
  public DrainManager(
      ...
      int numThreads,
      int maxDurationToDrainMs,
      int maxRecordsToDrain) {
    ...
    LOGGER.info(
        "Started DrainManager. numThreads={} maxDurationToDrainMs={} maxRecordsToDrain={}",
        numThreads,
  ...
  public void processWorKQueueItem(TableKey tableKey) {
    ...
    Drainer drainer =
        new Drainer(ingestEngineEpochTs, buffer, maxDurationToDrainMs, maxRecordsToDrain);
